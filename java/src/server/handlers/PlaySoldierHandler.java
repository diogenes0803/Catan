 ...
 *
 */
public class PlaySoldierHandler implements HttpHandler {
MovesFacade movesFacade = new MovesFacade();
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		PlaySoldierParams params = gson.fromJson(qry, PlaySoldierParams.class);
		CatanModel result = movesFacade.playSoldier(params, gameId);
