...
public interface IMapController extends IController {
    ...
    /**
     * This method is called whenever the user is trying to place a road on the map. It is called by the view for each
     * "mouse move" event. The returned value tells the view whether or not to allow the road to be placed at the
     * specified location.
     *
    ...
    /**
     * This method is called whenever the user is trying to place a settlement on the map. It is called by the view for
     * each "mouse move" event. The returned value tells the view whether or not to allow the settlement to be placed at
    ...
    /**
     * This method is called whenever the user is trying to place a city on the map. It is called by the view for each
     * "mouse move" event. The returned value tells the view whether or not to allow the city to be placed at the
     * specified location.
     *
    ...
    /**
     * This method is called whenever the user is trying to place the robber on the map. It is called by the view for
     * each "mouse move" event. The returned value tells the view whether or not to allow the robber to be placed at the
     * specified location.
     *
     ...
     * @param isFree            true if the piece should not cost the player resources, false otherwise. Set to true
     *                          during initial setup and when a road building card is played.
     * @param allowDisconnected true if the piece can be disconnected, false otherwise. Set to true only during initial
     *                          setup.
     */
    ...
    /**
     * This method is called when the user plays a "soldier" development card. It should initiate robber placement.
     */
    void playSoldierCard();

    /**
     * This method is called when the user plays a "road building" progress development card. It should initiate the
     * process of allowing the player to place two roads.
     */
