...
public class HttpURLResponse {
    ...
    /**
     * The actual response code.  Can be any user defined integer (usually defined as integer constants in a class) but
     * is usually a response code defined in HTTPURLConnection.
     */
    private int responseCode;

    /**
     * The length of the body in the response message.<br> <ol> <li>-1 means that the body is empty</li> <li>0 means
     * that the body is of arbitrary size</li> <li> &gt; 0 means that the body length is exactly the number of bytes
     * indicated. </ol>
     */
