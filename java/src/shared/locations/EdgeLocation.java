...
public class EdgeLocation {
    ...
    /**
     * Returns a canonical (i.e., unique) value for this edge location. Since each edge has two different locations on a
     * map, this method converts a hex location to a single canonical form. This is useful for using hex locations as
     * map keys.
     *
