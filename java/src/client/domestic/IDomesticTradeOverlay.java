...
public interface IDomesticTradeOverlay extends IOverlayView {
    ...
    /**
     * Sets the opponents the local player may trade with. This should be called on initializing the controller, and
     * only called once.
     *
     ...
     * @param amount   The string to be displayed as the resource's amount (can be empty)
     */
     ...
     *
     * @param resource    The resource for which amount changing is being enabled or disabled
